...
//       label: "General",
//       icon: <AppstoreAddOutlined />,
//       subMenu: [{ key: "kanban", label: "Kanban", linkTo: "/kanban-recruit", icon: <BlockOutlined /> }],
//     },
//     {
//       key: "candidates",
//       label: "Candidates",
  ...
  ROLE_RECRUITER: [
    {
      ...
      label: "General",
      icon: <AppstoreAddOutlined />,
      subMenu: [{ key: "dashboard", label: "Dashboard", linkTo: "/recruit-dashboard", icon: <BarChartOutlined />, },
        { key: "kanban", label: "Kanban", linkTo: "/kanban-recruit", icon: <BlockOutlined /> }
      ],
    },
    {
      key: "candidates",

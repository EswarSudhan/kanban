...
const WebCandidates = () => {
    ...
    useEffect(() => {
        ...
        axios.get(`http://172.235.21.99:3105/hiring/entryLevel/applyJob/${jobId}`, config)
            .then(response => {
    ...
    const handleReject = () => {
        ...
        const updateAdminCandidateData = (requestData) => {
            axios.post(`http://172.235.21.99:3105/hiring/auth/updatedataadmin/${requestData.resumeId}`, requestData)
                .then((response) => {

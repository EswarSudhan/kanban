...
class Dashboard extends Component {
  ...
  componentDidMount() {
    ...
    Promise.all([
      fetch('http://172.235.21.99:3105/hiring/auth/overallstats'),
      fetch('http://172.235.21.99:3105/hiring/auth/hiringPercentage'),
      fetch('http://172.235.21.99:3105/hiring/auth/jobstats'),
      fetch('http://172.235.21.99:3105/hiring/auth/expdata')
    ])

...
const Adminevaldashboard = () => {
  ...
  const handleModalOpen = (user) => {
    axios.get(`http://172.235.21.99:3105/hiring/auth/getallcadidatesforevalutaionbyid/${user.resumeId}`)
      .then(response => {
  ...
  const handleFormSubmit = (status) => {
    ...
    // Call the API
    axios.post("http://172.235.21.99:3105/hiring/auth/selectcandidatesstatus", {
